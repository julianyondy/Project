...
import 'bloc/simpanan_sukarela_bloc.dart';
import 'models/simpanan_sukarela_model.dart';

class SimpananSukarelaScreen extends StatelessWidget {
  const SimpananSukarelaScreen({super.key});

  static Widget builder(BuildContext context) {
    return BlocProvider<SimpananSukarelaBloc>(
      create: (context) => SimpananSukarelaBloc(SimpananSukarelaState(
        simpananSukarelaModelObj: SimpananSukarelaModel(),
      ))
        ..add(SimpananSukarelaInitialEvent()),
      child: const SimpananSukarelaScreen(),
    );
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4.h),
                BlocSelector<SimpananSukarelaBloc, SimpananSukarelaState,
  ...
  /// current [simpananSukarelaModelObj] object if the user selects a valid date.
  ///
  /// This function returns a `Future` that completes with `void`.
  Future<void> onTapDatetwo(BuildContext context) async {
    var initialState = BlocProvider.of<SimpananSukarelaBloc>(context).state;
    ...
    if (dateTime != null) {
      context.read<SimpananSukarelaBloc>().add(ChangeDateEvent(date: dateTime));
