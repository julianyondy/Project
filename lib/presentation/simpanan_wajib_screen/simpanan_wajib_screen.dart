...
import 'bloc/simpanan_wajib_bloc.dart';
...
class SimpananWajibScreen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<SimpananWajibBloc>(
      create: (context) => SimpananWajibBloc(SimpananWajibState(
        simpananWajibModelObj: SimpananWajibModel(),
      ))
        ..add(SimpananWajibInitialEvent()),
      child: const SimpananWajibScreen(),
    );
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4.h),
                BlocSelector<SimpananWajibBloc, SimpananWajibState,
  ...
  /// current [simpananWajibModelObj] object if the user selects a valid date.
  ///
  /// This function returns a `Future` that completes with `void`.
  Future<void> onTapDatetwo(BuildContext context) async {
    var initialState = BlocProvider.of<SimpananWajibBloc>(context).state;
